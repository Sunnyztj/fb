...
HTML;
	...
	public static function admin_menus_20() {
		add_submenu_page("Wordfence", "Wordfence Dashboard", "仪表板", "activate_plugins", "Wordfence", 'wordfence::menu_dashboard');
	}
	
	public static function admin_menus_30() {
		add_submenu_page("Wordfence", "Firewall", "防火墙", "activate_plugins", "WordfenceWAF", 'wordfence::menu_firewall');
	...
	public static function admin_menus_40() {
		add_submenu_page("Wordfence", "Scan", "扫描", "activate_plugins", "WordfenceScan", 'wordfence::menu_scan');
	}
	
	public static function admin_menus_50() {
		add_submenu_page('Wordfence', 'Tools', '工具', 'activate_plugins', 'WordfenceTools', 'wordfence::menu_tools');
	...
	public static function admin_menus_60() {
		if (wfConfig::get('displayTopLevelOptions')) {
			add_submenu_page("Wordfence", "All Options", "所有选项", "activate_plugins", "WordfenceOptions", 'wordfence::menu_options');
		}
	}
	
	public static function admin_menus_70() {
		add_submenu_page('Wordfence', 'Help', '帮助', 'activate_plugins', 'WordfenceSupport', 'wordfence::menu_support');
	}
	...
	public static function admin_menus_90() {
		if (wfConfig::get('isPaid')) {
			add_submenu_page("Wordfence", "Protect More Sites", "<strong id=\"wfMenuCallout\" style=\"color: #FCB214;\">保护更多网站</strong>", "activate_plugins", "WordfenceProtectMoreSites", 'wordfence::_menu_noop');
		}
		else {
