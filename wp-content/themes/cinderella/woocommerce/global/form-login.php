...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ( esc_attr($hidden) ) ? 'style="display:none;"' : ''; ?>>
	...
	<p class="form-row form-row-first">
		<input type="text" class="input-text" placeholder="<?php esc_attr_e( 'Username or email', 'cinderella' ); ?>" name="username" id="username" />
	</p>
	...
	<p class="form-row">
		...
		<label for="rememberme" class="inline">
			<input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php _e( 'Remember me', 'cinderella' ); ?>
		</label>
		<a class="lost_password" href="<?php echo esc_url( wp_lostpassword_url() ); ?>"><?php _e( 'Lost your password?', 'cinderella' ); ?></a>
	</p>
