...
function stm_load_theme_scripts_and_styles() {
	...
	if ( ! is_admin() ) {
		...
		wp_register_style('stm_default_fonts', '//fonts.googleapis.com/css?family=Arimo:400,400i,700,700i|Playfair+Display:400,400i,700,700i,900,900i&amp;subset=cyrillic,cyrillic-ext,greek,greek-ext,hebrew,latin-ext,vietnamese', null, STM_THEME_VERSION, 'all');

		if(!class_exists('ReduxFramework')){
			wp_enqueue_style('stm_default_fonts');
		}
...
function admin_styles() {
	...
	wp_register_style('stm_default_fonts', '//fonts.googleapis.com/css?family=Arimo:400,400i,700,700i|Playfair+Display:400,400i,700,700i,900,900i&amp;subset=cyrillic,cyrillic-ext,greek,greek-ext,hebrew,latin-ext,vietnamese', null, STM_THEME_VERSION, 'all');
	wp_enqueue_style( 'stm-gutenberg-styles', get_template_directory_uri() . '/assets/admin/css/gutenberg.css', null, STM_THEME_VERSION, 'all' );
	wp_enqueue_style('stm_default_fonts');
}
