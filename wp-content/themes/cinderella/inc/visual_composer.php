...
function vc_stm_elements(){
	...
	vc_map( array(
		...
		'weight' => - 50,
		'description' => __( 'Your sites WordPress Pages', 'cinderella' ),
		'params' => array(
			array(
				'type' => 'dropdown',
				'heading' => __( 'Order by', 'cinderella' ),
				'param_name' => 'sortby',
				'value' => array(
					__( 'Page title', 'cinderella' ) => 'post_title',
					__( 'Page order', 'cinderella' ) => 'menu_order',
					__( 'Page ID', 'cinderella' ) => 'ID'
				),
				'description' => __( 'Select how to sort pages.', 'cinderella' ),
				'admin_label' => true
			),
			array(
				'type' => 'textfield',
				...
				'param_name' => 'include',
				'description' => __( 'Enter page IDs to be excluded (Note: separate values by commas (,)).', 'cinderella' ),
				'admin_label' => true
			),
			array(
				'type' => 'textfield',
