...
if ( ! $parallax ) {
	if ( $bg_size ) {
		$row_style['bg_size'] = 'background-size: ' . $bg_size . ' !important;';
	}
	if ( $bg_position ) {
		$row_style['bg_position'] = 'background-position: ' . $bg_position . ' !important;';
	}
}
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ( ( $row_style ) ? ' style="' . esc_attr( implode( ' ', $row_style ) ) . '"' : '' ) . '>';
